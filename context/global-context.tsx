...
export function GlobalProvider({ children }: { children: React.ReactNode }) {
  ...
  const [businessSettings, setBusinessSettings] = useState<BusinessSettings>({
    ...
    country: "Pakistan",
    taxNumber: "",
    receiptFooter: "Thank you for shopping! Powered by MT Core — The core technology behind your business.",
    receiptHeader: "MT Core",
    defaultTaxRate: 0,
    defaultCurrency: "PKR",
    lowStockAlert: 10,
        ...
        fetch("/api/send-email", {
          ...
          try {
            ...
            const newLogEntry = {
              ...
              tenantId: targetTenantId,
              ownerName: req.name,
              subject: `[MT Core] Official SaaS Billing & Account Setup: ${req.businessName}`,
              plan: newInvoice.plan,
              billingCycle: bCycle,
              amount: newInvoice.amount,
              paidAmount: paidAmt,
